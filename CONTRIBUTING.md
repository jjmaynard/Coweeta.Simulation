...
* [Submit a post for your issue](https://github.com/jjmaynard/Coweeta.Simulation/issues/), assuming one does not already exist.
...
* [Fork](https://github.com/jjmaynard/Coweeta.Simulation/#fork-destination-box) the repository on GitHub to make a copy of the repository on your account. Or use this line in your shell terminal:

    `git clone git@github.com:your-username/Coweeta.Simulation.git`
...
* If you need help or unsure about anything, post an update to [your issue](https://github.com/jjmaynard/Coweeta.Simulation/issues/).

## Submitting your changes

Push to your fork and [submit a pull request](https://github.com/jjmaynard/Coweeta.Simulation/compare/).
...
* Engage in discussion on [your issue](https://github.com/jjmaynard/Coweeta.Simulation/issues/).
